...
//
// Lives here rather than in a module of its own so that it constructs after both objects above:
// its handler has to run after theirs, which is the order the separate module used to get from
// the import list.
