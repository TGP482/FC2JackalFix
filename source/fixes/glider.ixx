/* Based on An Almost Complete Guide to Far Cry 2 Modding */
...
// The guide's tested values: above 2420 gunfire stops registering, below it the glider still flips.
...
public:
    Glider()
    {
        ...
        {
            // Shot out of the sky. Factory entry to the second allocation.
            ...
            // Bouncing on water, half one: OnDiscarded, ending on the FLD the hook covers.
            ...
            // Bouncing on water, half two: IsSubmerged entry through the entity fetch. The hook
            // covers the seven-byte COMISS, which then reads the rewritten field.
            if (auto* pSubmerged = dunia_find("0F 57 C0 83 EC 0C 53 8B D9 0F 2F 83 14 01 00 00 73 63 8B 43 08 56 8B 70 08 83 46 08 01 57 8B 7E 0C 8B CF", 9))
            {
                ...
                {
                    // Shared by every vehicle, so rewritten for the paraglider alone.
